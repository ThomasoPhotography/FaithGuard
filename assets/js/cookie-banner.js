                ...
                <div class="row align-items-center">
                    <div class="col-md-8 col-12">
                        <p class="mb-0">
                            ...
                            <a href="cookie-policy.html" target="_blank" class="alert-link">Cookie Policy</a>, 
                            <a href="privacy-policy.html" target="_blank" class="alert-link">Privacy Policy</a>, and 
                            <a href="terms-of-service.html" target="_blank" class="alert-link">Terms of Service</a>.
                        </p>
                    </div>
                    <div class="col-md-4 col-12 text-md-end mt-2 mt-md-0">
                        <button id="accept-cookies" class="btn btn-success btn-sm me-2">Accept</button>
                        <button id="decline-cookies" class="btn btn-outline-secondary btn-sm">Decline</button>
                    </div>
                </div>
            </div>
        `;
