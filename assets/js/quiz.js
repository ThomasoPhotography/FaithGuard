...
const QUIZ_DATA = [
    ...
    { id: 3, question: 'I turn to my addiction instead of prayer when I feel stressed.', type: 'radio', name: 'q3_spiritual_stress', group: 'spiritual_health', options: LIKERT_SCALE },
    { id: 4, question: 'I feel distant from God because of my addictive habits.', type: 'radio', name: 'q4_spiritual_distant', group: 'spiritual_health', options: LIKERT_SCALE },
    { id: 5, question: 'My addiction makes me avoid church, fellowship, or spiritual practices.', type: 'radio', name: 'q5_spiritual_avoid', group: 'spiritual_health', options: LIKERT_SCALE },
    { id: 6, question: 'I feel convicted by the Holy Spirit when engaging in my addiction.', type: 'radio', name: 'q6_spiritual_convicted', group: 'spiritual_health', options: LIKERT_SCALE },
    { id: 7, question: 'I rely more on my addiction than on God for comfort or relief.', type: 'radio', name: 'q7_spiritual_comfort', group: 'spiritual_health', options: LIKERT_SCALE },

    // EMOTIONAL CONTROL & COPING (Q8-Q12) - Group: emotional_control
    { id: 8, question: 'I use my addiction to cope with difficult emotions.', type: 'radio', name: 'q8_emotional_cope', group: 'emotional_control', options: LIKERT_SCALE },
    { id: 9, question: 'I feel anxious or irritable when I can’t engage in my addiction.', type: 'radio', name: 'q9_emotional_anxious', group: 'emotional_control', options: LIKERT_SCALE },
    { id: 10, question: 'I feel guilt or shame after giving in to my addiction.', type: 'radio', name: 'q10_emotional_guilt', group: 'emotional_control', options: LIKERT_SCALE },
    { id: 11, question: 'My addiction feels like something I cannot control.', type: 'radio', name: 'q11_emotional_control', group: 'emotional_control', options: LIKERT_SCALE },
    { id: 12, question: 'I hide my struggles because I fear judgment from others.', type: 'radio', name: 'q12_emotional_hide', group: 'emotional_control', options: LIKERT_SCALE },

    // BEHAVIOURAL IMPACT (Q13-Q17) - Group: behavioural_impact
    { id: 13, question: 'I have tried to cut down but failed.', type: 'radio', name: 'q13_behaviour_failed', group: 'behavioural_impact', options: LIKERT_SCALE },
    { id: 14, question: 'I spend more time than intended engaging with my addiction.', type: 'radio', name: 'q14_behaviour_time', group: 'behavioural_impact', options: LIKERT_SCALE },
    { id: 15, question: 'I neglect responsibilities (school, work, home) because of my addiction.', type: 'radio', name: 'q15_behaviour_neglect', group: 'behavioural_impact', options: LIKERT_SCALE },
    { id: 16, question: 'I’ve taken risks or made unwise decisions because of my addiction.', type: 'radio', name: 'q16_behaviour_risk', group: 'behavioural_impact', options: LIKERT_SCALE },
    { id: 17, question: 'I experience cravings that feel overwhelming.', type: 'radio', name: 'q17_behaviour_cravings', group: 'behavioural_impact', options: LIKERT_SCALE },

    // RELATIONAL IMPACT (Q18-Q22) - Group: relational_impact
    { id: 18, question: 'My relationships have suffered because of my addiction.', type: 'radio', name: 'q18_relational_suffered', group: 'relational_impact', options: LIKERT_SCALE },
    { id: 19, question: 'I become defensive or irritated when someone confronts me about my habits.', type: 'radio', name: 'q19_relational_defensive', group: 'relational_impact', options: LIKERT_SCALE },
    { id: 20, question: 'I isolate myself to hide my addictive behaviour.', type: 'radio', name: 'q20_relational_isolate', group: 'relational_impact', options: LIKERT_SCALE },
    { id: 21, question: 'I avoid accountability from friends, family, or church.', type: 'radio', name: 'q21_relational_avoid', group: 'relational_impact', options: LIKERT_SCALE },
    { id: 22, question: 'My addiction causes conflict with people close to me.', type: 'radio', name: 'q22_relational_conflict', group: 'relational_impact', options: LIKERT_SCALE },

    // DAILY LIFE & FUNCTIONING (Q23-Q27) - Group: daily_functioning
    { id: 23, question: 'I delay tasks or responsibilities because of my addiction.', type: 'radio', name: 'q23_daily_delay', group: 'daily_functioning', options: LIKERT_SCALE },
    { id: 24, question: 'I prioritize my addiction over healthier activities.', type: 'radio', name: 'q24_daily_prioritize', group: 'daily_functioning', options: LIKERT_SCALE },
    { id: 25, question: 'My sleep schedule is negatively affected by my addiction.', type: 'radio', name: 'q25_daily_sleep', group: 'daily_functioning', options: LIKERT_SCALE },
    { id: 26, question: 'My finances are impacted because of my addiction.', type: 'radio', name: 'q26_daily_finance', group: 'daily_functioning', options: LIKERT_SCALE },
    { id: 27, question: 'My physical health has worsened due to addictive behaviours.', type: 'radio', name: 'q27_daily_health', group: 'daily_functioning', options: LIKERT_SCALE },

    // FAITH-BASED REFLECTION & ACCOUNTABILITY (Q28-Q32) - Group: faith_reflection
    { id: 28, question: 'I feel that my addiction is harming my relationship with God.', type: 'radio', name: 'q28_faith_harming', group: 'faith_reflection', options: LIKERT_SCALE },
    { id: 29, question: 'I avoid reading Scripture or praying when I slip into addiction.', type: 'radio', name: 'q29_faith_avoid_scripture', group: 'faith_reflection', options: LIKERT_SCALE },
    { id: 30, question: 'I feel unworthy of God’s forgiveness because of my addiction.', type: 'radio', name: 'q30_faith_unworthy', group: 'faith_reflection', options: LIKERT_SCALE },
    { id: 31, question: 'I struggle to trust God with my healing and recovery.', type: 'radio', name: 'q31_faith_struggle_trust', group: 'faith_reflection', options: LIKERT_SCALE },
    { id: 32, question: 'I believe my addiction is becoming an idol in my life.', type: 'radio', name: 'q32_faith_idol', group: 'faith_reflection', options: LIKERT_SCALE },

    // SELF-AWARENESS & DESIRE FOR CHANGE (Q33-Q36) - Group: self_awareness
    { id: 33, question: 'I want to stop, but I feel unable to do so.', type: 'radio', name: 'q33_self_unable', group: 'self_awareness', options: LIKERT_SCALE },
    { id: 34, question: 'I recognize patterns in my life that lead me toward my addiction.', type: 'radio', name: 'q34_self_recognize_patterns', group: 'self_awareness', options: LIKERT_SCALE },
    { id: 35, question: 'I worry about long-term consequences of my addictive behaviours.', type: 'radio', name: 'q35_self_worry', group: 'self_awareness', options: LIKERT_SCALE },
    { id: 36, question: 'I desire accountability or support to overcome my struggles.', type: 'radio', name: 'q36_self_desire_support', group: 'self_awareness', options: LIKERT_SCALE },
];
...
const submitQuiz = async (event) => {
    ...
    if (saveCurrentAnswer()) {
        ...
        const payload = {
            addiction_type: result.addictionType,
            // Format answers for the backend (e.g., array of objects or just values)
            answers: Object.keys(result.answers).map(key => ({
                key: key,
        ...
        try {
            ...
            if (data.success) {
                alert(`Quiz submitted successfully! Your score: ${result.totalScore.toFixed(2)}`);
